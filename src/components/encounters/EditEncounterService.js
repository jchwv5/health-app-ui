...
/**
 * Makes call to API to update anencounter
 * @param {*} id - encoutner ID to be updated
 ...
 */
export default async function updateEncounter(id,
  patientId,
  notes,
  visitCode,
  provider,
  ...
  setEncounterSuccess,
  setApiError) {
  await HttpHelper(`${constants.PATIENT_BY_ID_ENDPOINT + patientId}/encounters/${id}`, 'PUT', {
    id,
    patientId,
    notes,
    visitCode,
